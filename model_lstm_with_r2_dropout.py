...
# Load the dataset
df = pd.read_csv("D:\\Project\\MicroClimate-LSTM-main_2\\metting room\\datasheet3_resampling_10000.csv", encoding="utf8")
...
def run_optimization(tuning_method='bayes'):
    ...
    if tuning_method == 'bayes':
        search_space = [
            ...
            Integer(64, 1024, name='hidden_size'),
...
results_df.to_csv(f'output_baye/{round}/optimization_results_{tuning_method}_with_dropout.csv', index=False)
